...
WOri*(sum{b in B, m in T[b]} R[b,m]*X[b,m]- sum{b in B}C[b]*sum{m in T[b]}X[b,m]/(S[b]+1e-10)) - WSat*(sum{a in A, m in M}(d[a,m]*l[m] - sum{b in B1[a]}X[b,m]))- sum{b in B}g[b]; #Tweight-TS
